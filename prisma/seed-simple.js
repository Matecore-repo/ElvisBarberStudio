...
async function main() {
    ...
    const elvishHash = await bcryptjs_1.default.hash('elvis123', 10);
    const carlosHash = await bcryptjs_1.default.hash('carlos123', 10);
    const juanHash = await bcryptjs_1.default.hash('juan123', 10);
    const miguelHash = await bcryptjs_1.default.hash('miguel123', 10);
    // Crear usuario admin
